...
class Server
{
    private:
        ...
        */
        ...
        /**
         * Function called upon user disconnection
         * 
        ...
        */
        ...
        /**
         * Function checking whether the user application linked to the thread is timed out or not
         * 
        ...
        */
        ...
        /**
         * Function called to get the date given in seconds
         * 
        ...
        */
        ...
        /**
         * Function called to add the recently requested book to the user's stats
         * 
...
/**
 * Specialised Thread start routine (a thread that will add an entry to a user's data)
 * 
 * @param argument = address to the structure containing the information that the thread requires
 */
void* specialisedThreadStatusAdd(void*);

/**
 * Function that returns an address to the user's data file
 * 
    ...
    while(true)
    {
        ...
        if(!strcmp(request, "CLIENTEVENTRECO"))
        {
            ...
            else
            {
                ...
                if( 0 >= write(threadDataLocal.clientDescriptor ,this->sentInfo, sizeof(DBResult)*5))
                    this->ReportLog(threadWriteError, threadDataLocal.idThread, threadDataLocal.linkedUser);
                if( 0 >= write(threadDataLocal.clientDescriptor, &this->maxEntries, 4))
                    this->ReportLog(threadWriteError, threadDataLocal.idThread, threadDataLocal.linkedUser);
            }
