...
void MainWindow::AddToList(DBResult * array, const int & length)
{
    ...
    {/*
        ...
        //ui->tableWidgetQueryResult->item(i,0)->setFlags(Qt::ItemIsSelectable);
...
void MainWindow::InitLibrary()
{
    ...
    tableHeader << "ISBN" << "Title" << "Author" << "Genre" << "Publish Year" << "Rating" << "Download";
    ...
    this->ui->tableWidgetQueryResult->setColumnWidth(2,240);
