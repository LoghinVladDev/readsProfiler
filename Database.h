...
class Database
{
    ...
    public:
        ...
        */
        ...
        /**
         * Function used to decode the recommended books filter to DBFilter*, a structure containing filter variables
         * 
         * @param givenFilter = address of the filter in which the settings will be saved
         */
        ...
        /**
         * Function called to add an entry into the database, called when an account is created
         * 
        ...
        /**
         * Function that checks whether an account with the given username already exists
         * 
